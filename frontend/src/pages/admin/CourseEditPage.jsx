...
export default function CourseEditPage() {
            ...
            try {
                ...
                if (isMounted) {
                    ...
                    setForm({
                        ...
                        schoolClassId: courseData.schoolClassId || '',
                        leadTeacherId: courseData.leadTeacherId || '',
                        endDate: courseData.endDate ? courseData.endDate.substring(0, 16) : ''
                    });
                }
                ...
                if (isMounted) {
                    setError(err.response?.data?.message || 'Kunde inte hämta data.');
                }
            } finally {
    ...
    if (!form) return <div className="p-8 text-center">Ingen kurs hittades.</div>;

    return (
        <div className="p-8">
            <div className="max-w-2xl mx-auto">
                <h1 className="text-3xl font-bold mb-6">Redigera Kurs</h1>
                <Card>
                    <CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select 
                                    ...
                                    onValueChange={val => setForm({...form, schoolClassId: val})}
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    <SelectTrigger id="lead-teacher" className="w-full">
                                        <SelectValue placeholder="Välj en lärare" />
                                    </SelectTrigger>
                                    <SelectContent>
