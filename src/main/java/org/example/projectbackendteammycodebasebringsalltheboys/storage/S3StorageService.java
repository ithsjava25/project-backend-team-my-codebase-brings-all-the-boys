...
public class S3StorageService implements StorageService {
     ...
     *
     * <p>The returned stream is the underlying {@link ResponseInputStream} produced by
     * {@link S3Client#getObject(GetObjectRequest)}. Callers are responsible for closing the
     * returned stream to ensure network resources are released.
     *
