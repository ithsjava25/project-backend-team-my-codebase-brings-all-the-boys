...
class ActivityLogControllerTest {
    ...
    void getUserActivityLogs_AdminAccess() throws Exception {
        ...
        Mockito.when(activityLogService.getLogsForUser(Mockito.eq(targetUser), Mockito.any(Pageable.class)))
    ...
    @Test
    @WithMockUser(username = "bob_student", roles = {"STUDENT"})
    ...
    void getEntityActivityLogs_AdminAccess() throws Exception {
        ...
        Mockito.when(userService.getUserByUsername("admin")).thenReturn(Optional.of(admin));
        Mockito.when(activityLogService.getLogsForEntity(
                        Mockito.eq("Assignment"),
                        Mockito.eq(entityId),
